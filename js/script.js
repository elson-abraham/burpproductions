...
var CLIENT_ID =  "266322340855-olkv8ub9njsh7tjesbfuvbcm8a6lff7c.apps.googleusercontent.com";
var API_KEY = "AIzaSyBlZyUBNtCTzPIT6EY1SxKAJEC6Ul_S2p4";
...
function handleAuthClick() {
  ...
  if (gapi.client.getToken() === null) {    
    tokenClient.requestAccessToken({ prompt: "consent" });      // Prompt the user to select a Google Account and ask for consent to share their data when establishing a new session. 
  } else {
    tokenClient.requestAccessToken({ prompt: "" });             // Skip display of account chooser and consent dialog for an existing session.
  }
}
...
// check for an Upload folder in google drive
